"""
Satu Module - FastAPI Application
Автономное API приложение для работы с Satu.kz
"""
...
app = FastAPI(
    title="Satu.kz Module",
    description="Autonomous Satu integration module for Lead Generation System",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
...
async def startup_event():
    ...
    logger.info(f"Starting Satu Module on {settings.module_host}:{settings.module_port}")
...
async def shutdown_event():
    ...
    logger.info("Shutting down Satu Module")
