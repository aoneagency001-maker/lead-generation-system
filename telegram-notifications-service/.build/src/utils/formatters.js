...
exports.formatVisitorMessage = formatVisitorMessage;
exports.formatContactMessage = formatContactMessage;
exports.formatMetrikaMessage = formatMetrikaMessage;
/**
 * Форматировать сообщение о визите
 */
function formatVisitorMessage(event, clientName) {
    const parts = [];
    // Заголовок
    ...
    const utmParts = [];
    if (event.utmSource)
        utmParts.push(`Source: ${event.utmSource}`);
    if (event.utmMedium)
        utmParts.push(`Medium: ${event.utmMedium}`);
    if (event.utmCampaign)
        utmParts.push(`Campaign: ${event.utmCampaign}`);
 ...
 */
function formatContactMessage(event, clientName) {
    const parts = [];
    // Заголовок
 ...
 */
function formatMetrikaMessage(event, clientName) {
    const parts = [];
    // Заголовок
